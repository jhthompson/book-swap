# Generated by Django 5.2 on 2025-10-08 03:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('openlibrary_author_id', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='OpenLibrary Author ID')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('isbn', isbn_field.fields.ISBNField(blank=True, max_length=28, null=True, unique=True, validators=[isbn_field.validators.ISBNValidator], verbose_name='ISBN')),
                ('openlibrary_edition_id', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='OpenLibrary Edition ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AVAILABLE', 'Available'), ('SWAPPED', 'Swapped'), ('REMOVED', 'Removed')], default='AVAILABLE', max_length=9)),
